...
logging.basicConfig(
    level=logging.INFO,
    handlers=[
        logging.FileHandler("C:/Users/vatsa/Documents/Python/chat_with/Chat_With_All/logs/chat_app.log"),
...
for directory in ['C:/Users/vatsa/Documents/Python/chat_with/Chat_With_All/logs', 'C:/Users/vatsa/Documents/Python/chat_with/Chat_With_All/vector_store', 'C:/Users/vatsa/Documents/Python/chat_with/Chat_With_All/uploads', 'C:/Users/vatsa/Documents/Python/chat_with/Chat_With_All/static', 'C:/Users/vatsa/Documents/Python/chat_with/Chat_With_All/templates']:
...
def chat_with_image(prompt, image_data, model="gemma3"):
...
def get_models():
    models = ['gemma3','qwen2.5:1.5b', 'codellama', 'llama3.2']
...
def process_pdf():
    ...
    if file and file.filename.endswith('.pdf'):
        filename = f"C:/Users/vatsa/Documents/Python/chat_with/Chat_With_All/uploads/{int(time.time())}_{file.filename}"
        file.save(filename)
...
def chat():
    ...
    with open(os.path.join('C:/Users/vatsa/Documents/Python/chat_with/Chat_With_All/logs', f'queries_{datetime.now().strftime("%Y%m%d")}.json'), 'a') as f:
